...
5. Automatically detect the best S/MIME certificate and create a new security profile, specifying the default hash algorithm:	MapiSmimeToolkit.exe -u EMAIL_ADDRESS -o -d
For example: MapiSmimeToolkit.exe -u user@contoso.com -o -d. Please note the e-mail address must match the certificate name.
